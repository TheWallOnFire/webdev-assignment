  ...
  return (
    <div className="w-full h-full mt-4">
      <ResponsiveContainer width="100%" height={400}>
        <BarChart data={chartData} margin={{ top: 30, right: 30, left: 20, bottom: 25 }}>
          <CartesianGrid strokeDasharray="3 3" stroke="#334155" vertical={false} />
          <XAxis dataKey="name" stroke="#94a3b8" tick={{ fill: '#94a3b8', fontSize: 12 }} tickLine={false} axisLine={false} dy={10}>
            <Label value="Score Range" position="insideBottom" offset={-15} fill="#94a3b8" fontSize={13} />
          </XAxis>
          <YAxis stroke="#94a3b8" tick={{ fill: '#94a3b8', fontSize: 12 }} tickLine={false} axisLine={false} allowDecimals={false} dx={-10}>
            <Label value="Number of Students" angle={-90} position="insideLeft" offset={-10} fill="#94a3b8" fontSize={13} style={{ textAnchor: 'middle' }} />
          </YAxis>
          <Tooltip 
            cursor={{ fill: '#1e293b' }}
