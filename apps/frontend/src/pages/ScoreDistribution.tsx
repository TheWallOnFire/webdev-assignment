      ...
      <div className="bg-secondary/50 border border-white/5 rounded-xl shadow-sm p-8">
        <div
          className={
            ...
            'mb-8 gap-4 border-b border-white/5 pb-6'
          }
        >
          <div>
            ...
            <p className="text-sm text-slate-400">
              Analyze the distribution of scores across different brackets
            </p>
          </div>
            ...
            >
              {SUBJECTS_LIST.map((s) => (
                <option
                  key={s.id}
                  value={s.id}
                  className="bg-background text-slate-200"
                >
                  {s.name}
                </option>
              ))}
        ...
        <div className="flex-1 min-h-[400px] flex flex-col justify-center relative">
          ...
          {!error && !loading && chartData.length === 0 && (
            <div
              className={
                'text-center text-slate-500 flex flex-col items-center'
              }
            >
              <svg
