  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="bg-secondary/50 border border-white/5 rounded-xl shadow-sm p-8">
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-slate-100 mb-1">Score Checker</h1>
          <p className="text-sm text-slate-400">Enter a student's registration number to view their exam results.</p>
        </div>

        <form onSubmit={handleFetchScore} className="flex gap-4">
          <input 
            type="text" 
