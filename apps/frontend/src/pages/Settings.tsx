    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="bg-secondary/50 border border-white/5 rounded-xl shadow-sm p-8">
        <div className="mb-6 border-b border-white/5 pb-4">
          <h2 className="text-xl font-semibold text-slate-100 mb-1">About This Application</h2>
          <p className="text-sm text-slate-400">Information about the G-Scores project.</p>
        </div>
        
        <div className="space-y-4 text-slate-300 text-sm">
          <p>
            <strong className="text-slate-200">G-Scores</strong> is a high-performance web application designed to quickly search and analyze the 2024 National High School Exam results.
          </p>
          <p>
            It provides instantaneous registration number lookups, detailed score distributions by subject, and automated rankings for Top Group A students. The system is built with a scalable microservices architecture utilizing NestJS, Prisma, and Redis on the backend, alongside a modern React and Vite frontend.
          </p>
          ...
          <div className="pt-4 mt-6 border-t border-white/5 flex flex-col gap-3">
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium text-slate-200">The Wall On Fire</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-slate-400">Version</span>
              <span className="font-medium text-slate-200">1.0.0 (Production)</span>
            </div>
            <div className="flex items-center justify-between">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="text-primary hover:text-blue-400 transition-colors font-medium flex items-center gap-1"
              >
                GitHub 
