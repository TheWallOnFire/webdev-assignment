  ...
  return (
    <div className="flex h-screen bg-background text-slate-300 font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        <header className="h-16 px-4 md:px-8 flex items-center border-b border-white/5 bg-secondary/10 shrink-0">
          <button
        ...
        <main className="flex-1 p-4 md:p-8 overflow-y-auto flex flex-col">
          ...
          <footer className="mt-8 pt-6 border-t border-white/5 text-center text-sm text-slate-500 shrink-0">
            <p className="mt-1 text-xs opacity-75">&copy; {new Date().getFullYear()} The Wall On Fire. All rights reserved.</p>
          </footer>
        </main>
      </div>
    </div>
